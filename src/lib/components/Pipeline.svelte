<script lang="ts">
    ...
    const stages = [
        ...
        bgColor: 'bg-bismuth-copper-300/80',
        ...
        bgColor: 'bg-bismuth-primary-300/80',
        ...
        bgColor: 'bg-bismuth-secondary-300/80',
        ...
        bgColor: 'bg-bismuth-blue-500/80', // Changed from mint to match development style
        iconColor: 'text-bismuth-primary-300',
        progressColor: 'bg-bismuth-primary-300',
        interactive: true,
        isProduct: true,
    ...
    <div class="relative ml-[30px] sm:ml-[65px] ml-1/2 flex flex-col">
      ...
      <div class="absolute top-0 left-3/4 h-full w-[2px] bg-neutral-dark/20 -translate-x-1/2 md:hidden"/>
        {#each stages as stage, index}
          <div 
            class="flex flex-row md:flex-col items-center group"
          ...
          >
            ...
            <div class="relative">
              <div 
                class="w-12 h-12 rounded-lg {stage.bgColor} p-2 flex items-center justify-center
              ...
              {#if progress[index] > 0}
                <div 
                  class="absolute -inset-1 rounded-lg {stage.progressColor}/20"
                  style="clip-path: polygon(50% 0%, 100% 0%, 100% {progress[index]}%, 0% {progress[index]}%, 0% 0%)"
                  transition:fade
                />
              {/if}
            ...
            <div class="ml-4 md:ml-0 md:mt-4 flex flex-col items-center">
